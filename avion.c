...
/*******************************!
*@fn *enteroACadena
**Es una funcion que transaforma un valor entero a cadena
*@param c1 int valor
*@param c2 puntero char cadena
*@return char cadena
********************************/
...
/*******************************!
*@fn char * armarMensaje
**
*@param c1 int cliente
*@param c2 char * IP
*@param c3 ST_AVION * avion
*@param c4 int charOpcion
...
/*******************************!
*@fn void parsearLinea
*@file c1 FILE* pArchivo
